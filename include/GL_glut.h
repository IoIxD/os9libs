/*
        ...
        Copyright:	Copyright � Mark J. Kilgard, 1994 - 1999
                                MacOS portions Copyright � Apple Computer, Inc.,
   1999
        ...
        <4+>     8/28/99    ggs
         ...
         <1>     6/22/99    ggs     Readded to source control because of project
   name change <4>     5/31/99    GGS <3>     5/31/99    ggs     Added
   glutInitMac, glutCreatePlainWindow, and glutAddnamedMenu <2>     5/31/99 ggs
   Added initial macintosh compiler switch <1>     5/31/99    ggs
*/
